 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://realhomegta.ca//PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <img src="../images/arshad.png" alt="" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                            <asp:Label ID="lblname"  runat="server"></asp:Label>Ashok Nagre</h2>
                            <p>Real Estate Broker</p>
                            <asp:Label CssClass="email_profile_r" ID="lblemail" runat="server"></asp:Label>
                            <span class="email_profile_r">905-601-1010</span>
                        </div>
                    </div>
